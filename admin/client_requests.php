...
<?php 
$delid  =  $_REQUEST['del'];
 $delQuery = "DELETE FROM `client` WHERE client_id = '$delid'";
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<?php
								...
								$select = "SELECT client.client_id,client.fname,client.phone,cars.car_name,cars.hire_cost,client.status 
										FROM client JOIN cars ON client.car_id=cars.car_id  ORDER BY client_id DESC";
							...
							<tr>
								...
								<td><a href="javascript:sureToApprove(<?php echo $row['client_id'];?>)" class="ico del">Approve</a><a href="<?php echo '?del='.$row['client_id'];?>" class="ico edit">Delete</a></td>
							</tr>
							<?php
								}
							?>
